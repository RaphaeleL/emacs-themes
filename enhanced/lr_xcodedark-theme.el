...
(let* ((class '((class color) (min-colors 89)))
       (xcodedark-colors
        '(
          ...
          ;; Additional colors
          (bg-1         . "#0f0f14")   ;; Darker background
          (bg+1         . "#2f2f34")   ;; Slightly lighter than bg
          (bg+2         . "#3f3f44")   ;; Even lighter
          (bg+3         . "#4f4f54")   ;; Selection background variant
          (bg+4         . "#5f5f64")   ;; Warm grey
          (red-1        . "#cc6e62")   ;; Darker red
          (red+1        . "#ff9a8a")   ;; Brighter red
          (fg+1         . "#ffffff")   ;; Lighter foreground
          (fg+2         . "#ffffff")   ;; Even lighter foreground
          (grey         . "#8E8E93")   ;; Grey
          (brown        . "#FFD479")   ;; Brown (same as yellow)
          (niagara-2    . "#2a2f3a")   ;; Dark niagara
          (niagara-1    . "#4a5f7a")   ;; Medium niagara
          (niagara      . "#4EB0CC")   ;; Blue (same as br-blue)
          (quartz       . "#4EB0CC")   ;; Blue (same as br-blue)
          (wisteria     . "#FF7AB2")   ;; Magenta (same as br-magenta)
          ))
