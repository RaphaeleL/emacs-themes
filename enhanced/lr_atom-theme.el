...
(let* ((class '((class color) (min-colors 89)))
       (atom-colors
        '(
          ...
          ;; Additional colors
          (bg-1         . "#0f1011")   ;; Darker background
          (bg+1         . "#1f2021")   ;; Slightly lighter than bg
          (bg+2         . "#2a2b2c")   ;; Even lighter
          (bg+3         . "#3a3b3c")   ;; Selection background variant
          (bg+4         . "#4a4b4c")   ;; Warm grey
          (red-1        . "#a35252")   ;; Darker red
          (red+1        . "#d67a7a")   ;; Brighter red
          (fg+1         . "#d5d8d6")   ;; Lighter foreground
          (fg+2         . "#e5e8e6")   ;; Even lighter foreground
          (grey         . "#969896")   ;; Grey
          (brown        . "#f0c674")   ;; Brown (same as yellow)
          (niagara-2    . "#2a2f35")   ;; Dark niagara
          (niagara-1    . "#4a5560")   ;; Medium niagara
          (niagara      . "#81a2be")   ;; Blue (same as br-blue)
          (quartz       . "#81a2be")   ;; Blue (same as br-blue)
          (wisteria     . "#b294bb")   ;; Magenta (same as br-magenta)
          ))
