...
(let* ((class '((class color) (min-colors 89)))
       (apple_system_colors-colors
        '(
          ...
          (red-1        . "#CC2F26")   ;; Darker red
          (red+1        . "#FF4D43")   ;; Brighter red
          ...
          (niagara      . "#0a84ff")   ;; Blue (same as br-blue)
          (quartz       . "#0a84ff")   ;; Blue (same as br-blue)
          (wisteria     . "#bf5af2")   ;; Bright magenta (same as br-magenta)
          ))
