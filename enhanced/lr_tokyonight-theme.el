...
(let* ((class '((class color) (min-colors 89)))
       (tokyonight-colors
        '(
          ...
          ;; Additional colors
          (bg-1         . "#0f0f16")   ;; Darker background
          (bg+1         . "#2a2b36")   ;; Slightly lighter than bg
          (bg+2         . "#3a3b46")   ;; Even lighter
          (bg+3         . "#4a4b56")   ;; Selection background variant
          (bg+4         . "#5a5b66")   ;; Warm grey
          (red-1        . "#c55e6e")   ;; Darker red
          (red+1        . "#ff8e9e")   ;; Brighter red
          (fg+1         . "#b9c1e6")   ;; Lighter foreground
          (fg+2         . "#c9d1f6")   ;; Even lighter foreground
          (grey         . "#565a6e")   ;; Grey
          (brown        . "#e0af68")   ;; Brown (same as yellow)
          (niagara-2    . "#2a2f3a")   ;; Dark niagara
          (niagara-1    . "#4a5f7a")   ;; Medium niagara
          (niagara      . "#7aa2f7")   ;; Blue (same as br-blue)
          (quartz       . "#7aa2f7")   ;; Blue (same as br-blue)
          (wisteria     . "#bb9af7")   ;; Magenta (same as br-magenta)
          ))
