...
(let* ((class '((class color) (min-colors 89)))
       (solarized_dark-colors
        '(
          ...
          ;; Additional colors
          (bg-1         . "#0f0f15")   ;; Darker background
          (bg+1         . "#2a2b35")   ;; Slightly lighter than bg
          (bg+2         . "#3a3b45")   ;; Even lighter
          (bg+3         . "#4a4b55")   ;; Selection background variant
          (bg+4         . "#5a5b65")   ;; Warm grey
          (red-1        . "#b9635f")   ;; Darker red
          (red+1        . "#ff978f")   ;; Brighter red
          (fg+1         . "#d2daf1")   ;; Lighter foreground
          (fg+2         . "#e2eaf1")   ;; Even lighter foreground
          (grey         . "#424866")   ;; Grey
          (brown        . "#d8b172")   ;; Brown (same as yellow)
          (niagara-2    . "#2a2f3a")   ;; Dark niagara
          (niagara-1    . "#4a5f7a")   ;; Medium niagara
          (niagara      . "#82a1f1")   ;; Blue (same as br-blue)
          (quartz       . "#82a1f1")   ;; Blue (same as br-blue)
          (wisteria     . "#b69bf1")   ;; Magenta (same as br-magenta)
          ))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-doc-markup-face               ((,class :foreground ,(funcall safe-get-color 'br-black) :weight bold)))
   ...
   `(font-lock-variable-use-face             ((,class :foreground ,(funcall safe-get-color 'blue))))
