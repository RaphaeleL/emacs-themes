...
(let* ((class '((class color) (min-colors 89)))
       (doomone-colors
        '(
          ...
          (bg+1         . "#383c44")   ;; Slightly lighter than bg
          (bg+2         . "#484c54")   ;; Even lighter
          (bg+3         . "#585c64")   ;; Selection background variant
          (bg+4         . "#686c74")   ;; Warm grey
          (red-1        . "#cc5556")   ;; Darker red
          (red+1        . "#ff7d7e")   ;; Brighter red
          (fg+1         . "#cbc2df")   ;; Lighter foreground
          (fg+2         . "#dbc2ef")   ;; Even lighter foreground
          (grey         . "#5b6268")   ;; Grey
          (brown        . "#ecbe7b")   ;; Brown (same as yellow)
          (niagara-2    . "#2a2f3c")   ;; Dark niagara
          (niagara-1    . "#4a5f7c")   ;; Medium niagara
          (niagara      . "#51afef")   ;; Blue (same as br-blue)
          (quartz       . "#51afef")   ;; Blue (same as br-blue)
          (wisteria     . "#c678dd")   ;; Magenta (same as br-magenta)
          ))
