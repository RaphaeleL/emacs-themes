...
(let* ((class '((class color) (min-colors 89)))
       (molokai-colors
        '(
          ...
          ;; Additional colors
          (bg-1         . "#0f0f0f")   ;; Darker background
          (bg+1         . "#2b2b2b")   ;; Slightly lighter than bg
          (bg+2         . "#3b3b3b")   ;; Even lighter
          (bg+3         . "#4b4b4b")   ;; Selection background variant
          (bg+4         . "#5b5b5b")   ;; Warm grey
          (red-1        . "#cc0000")   ;; Darker red
          (red+1        . "#ff3333")   ;; Brighter red
          ...
          (wisteria     . "#F92672")   ;; Magenta (same as br-magenta)
          ))
