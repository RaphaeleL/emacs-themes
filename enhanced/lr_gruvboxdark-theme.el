...
(let* ((class '((class color) (min-colors 89)))
       (gruvboxdark-colors
        '(
          ...
          (bg+1         . "#383838")   ;; Slightly lighter than bg
          (bg+2         . "#484848")   ;; Even lighter
          (bg+3         . "#585858")   ;; Selection background variant
          (bg+4         . "#686868")   ;; Warm grey
          (red-1        . "#a31a1a")   ;; Darker red
          (red+1        . "#e62a2a")   ;; Brighter red
          (fg+1         . "#fbdbb2")   ;; Lighter foreground
          (fg+2         . "#ffedb2")   ;; Even lighter foreground
          (grey         . "#928374")   ;; Grey
          (brown        . "#d79921")   ;; Brown (same as yellow)
          (niagara-2    . "#2a2f38")   ;; Dark niagara
          (niagara-1    . "#4a5f78")   ;; Medium niagara
          (niagara      . "#83a598")   ;; Blue (same as br-blue)
          (quartz       . "#83a598")   ;; Blue (same as br-blue)
          (wisteria     . "#d3869b")   ;; Magenta (same as br-magenta)
          ))
  ...
  (custom-theme-set-faces
   ...
   ;; Modeline faces - Gruvbox Dark style
