...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces 'lr_gruberdarker
   ...
   `(font-lock-doc-string-face               ((,class :foreground ,(funcall safe-get-color 'grey) :slant italic)))
   `(font-lock-doc-markup-face               ((,class :foreground ,(funcall safe-get-color 'grey) :weight bold)))
