...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces 'lr_gruberdarker
   ...
   `(font-lock-doc-face                      ((,class :foreground ,(funcall safe-get-color 'brown) :slant italic)))
   `(font-lock-doc-string-face               ((,class :foreground ,(funcall safe-get-color 'brown) :slant italic)))
   `(font-lock-doc-markup-face               ((,class :foreground ,(funcall safe-get-color 'brown) :weight bold)))
   `(font-lock-function-call-face            ((,class :foreground ,(funcall safe-get-color 'magenta) :weight bold)))
   ...
   `(font-lock-punctuation-face              ((,class :foreground ,(funcall safe-get-color 'brown))))
   `(font-lock-regexp-grouping-backreference ((,class :foreground ,(funcall safe-get-color 'brown))))
   `(font-lock-regexp-grouping-backslash     ((,class :foreground ,(funcall safe-get-color 'brown))))
   `(font-lock-regexp-grouping-construct     ((,class :foreground ,(funcall safe-get-color 'brown))))
   `(font-lock-reference-face                ((,class :foreground ,(funcall safe-get-color 'blue))))
   `(font-lock-string-face                   ((,class :foreground ,(funcall safe-get-color 'green))))
   `(font-lock-type-face                     ((,class :foreground ,(funcall safe-get-color 'quartz) :weight bold)))
