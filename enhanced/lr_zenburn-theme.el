...
(let* ((class '((class color) (min-colors 89)))
       (zenburn-colors
        '(
          ...
          ;; Additional colors
          (bg-1         . "#2f2f2f")   ;; Darker background
          (bg+1         . "#4f4f4f")   ;; Slightly lighter than bg
          (bg+2         . "#5f5f5f")   ;; Even lighter
          (bg+3         . "#6f6f6f")   ;; Selection background variant
          (bg+4         . "#7f7f7f")   ;; Warm grey
          (red-1        . "#a37373")   ;; Darker red
          (red+1        . "#d6b3b3")   ;; Brighter red
          (fg+1         . "#ececcc")   ;; Lighter foreground
          (fg+2         . "#fcfcdc")   ;; Even lighter foreground
          (grey         . "#709080")   ;; Grey
          (brown        . "#f0dfaf")   ;; Brown (same as yellow)
          (niagara-2    . "#2a2f3a")   ;; Dark niagara
          (niagara-1    . "#4a5f7a")   ;; Medium niagara
          (niagara      . "#8cd0d3")   ;; Blue (same as br-blue)
          (quartz       . "#8cd0d3")   ;; Blue (same as br-blue)
          (wisteria     . "#dc8cc3")   ;; Magenta (same as br-magenta)
          ))
