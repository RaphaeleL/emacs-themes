(deftheme tokyonight
  "Tokyo Night theme - A clean, dark Emacs theme that showcases the original Tokyo Night colors.")
...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Modeline faces - Tokynight style
